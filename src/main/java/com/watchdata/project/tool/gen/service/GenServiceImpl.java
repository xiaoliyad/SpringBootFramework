package com.watchdata.project.tool.gen.service;
...
import com.watchdata.project.tool.gen.util.GenUtils;
import com.watchdata.project.tool.gen.util.VelocityInitializer;
...
public class GenServiceImpl implements IGenService
{
     ...
     */
    @Override
    public byte[] generatorCode(String moduleName,String tableName)
    {
        ...
        // 生成代码
        generatorCode(moduleName,table, columns, zip);
     ...
     * 生成代码
     */
    public void generatorCode(String moduleName,TableInfo table, List<ColumnInfo> columns, ZipOutputStream zip)
    {
        // 表名转换成Java属性名
